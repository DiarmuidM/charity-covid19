...
Using publicly available data collected on 10 August 2020, the following are the trends in registrations (foundations) and de-registrations (dissolutions) for the following jurisdictions:
* England and Wales
* Scotland
* Northern Ireland
...
![Monthly registrations]({{site.url}}/figures/ew-monthly-registrations-2020-08-10.png)

*Figure 2. Cumulative registrations of charities - England and Wales*

![Cumulative registrations]({{site.url}}/figures/ew-monthly-cumulative-registrations-2020-08-10.png)
...
![Monthly removals]({{site.url}}/figures/ew-monthly-removals-2020-08-10.png)

*Figure 4. Cumulative de-registrations of charities - England and Wales*

![Cumulative removals]({{site.url}}/figures/ew-monthly-cumulative-removals-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/scot-monthly-registrations-2020-08-10.png)

*Figure 6. Cumulative registrations of charities - Scotland*

![Cumulative registrations]({{site.url}}/figures/scot-monthly-cumulative-registrations-2020-08-10.png)
...
![Monthly removals]({{site.url}}/figures/scot-monthly-removals-2020-08-10.png)

*Figure 8. Cumulative de-registrations of charities - Scotland*

![Cumulative removals]({{site.url}}/figures/scot-monthly-cumulative-removals-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/ni-monthly-registrations-2020-08-10.png)

*Figure 10. Cumulative registrations of charities - Northern Ireland*

![Cumulative registrations]({{site.url}}/figures/ni-monthly-cumulative-registrations-2020-08-10.png)

#### De-registrations

*Figure 11. Monthly de-registrations of charities - Northern Ireland*

![Monthly removals]({{site.url}}/figures/ni-monthly-removals-2020-08-10.png)

*Figure 12. Cumulative de-registrations of charities - Northern Ireland*

![Cumulative removals]({{site.url}}/figures/ni-monthly-cumulative-removals-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/aus-monthly-registrations-2020-08-10.png)

*Figure 14. Cumulative registrations of charities - Australia*

![Cumulative registrations]({{site.url}}/figures/aus-monthly-cumulative-registrations-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/nz-monthly-registrations-2020-08-10.png)

*Figure 16. Cumulative registrations of charities - New Zealand*

![Cumulative registrations]({{site.url}}/figures/nz-monthly-cumulative-registrations-2020-08-10.png)
...
![Monthly removals]({{site.url}}/figures/nz-monthly-removals-2020-08-10.png)

*Figure 18. Cumulative de-registrations of charities - New Zealand*

![Cumulative removals]({{site.url}}/figures/nz-monthly-cumulative-removals-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/can-monthly-registrations-2020-08-10.png)

*Figure 20. Cumulative registrations of charities - Canada*

![Cumulative registrations]({{site.url}}/figures/can-monthly-cumulative-registrations-2020-08-10.png)
...
![Monthly removals]({{site.url}}/figures/can-monthly-removals-2020-08-10.png)

*Figure 22. Cumulative de-registrations of charities - Canada*

![Cumulative removals]({{site.url}}/figures/can-monthly-cumulative-removals-2020-08-10.png)
...
![Monthly registrations]({{site.url}}/figures/us-monthly-registrations-2020-08-10.png)

*Figure 24. Cumulative registrations of charities - USA*

![Cumulative registrations]({{site.url}}/figures/us-monthly-cumulative-registrations-2020-08-10.png)